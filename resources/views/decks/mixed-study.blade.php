...
@section('title', 'SRS Review: ' . $deck->name . ' \ Syllaboost')
...
@section('content')
    ...
    <script>
        (() => {
            ...
            // ── Card data (includes id and deck_id for rating submission) ─────────────────
            @php
            ...
            function submitRating(cardId, deckId, rating) {
                ...
                fetch(RATINGS_URL, {
                    ...
                    body: JSON.stringify({ card_id: cardId, deck_id: deckId, rating, is_srs: true }),
                }).catch(() => {});
            }
            ...
            function rateAndNext(direction) {
                ...
                submitRating(card.id, card.deck_id, direction);
