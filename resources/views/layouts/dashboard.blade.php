        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 space-y-2 px-4 py-4 overflow-y-auto">
                ...
                <a href="{{ route('community.index') }}"
                    class="group flex items-center w-full px-4 py-2.5 rounded-lg font-medium transition-colors {{ request()->routeIs('community.*') ? 'bg-sky-100 text-sky-500' : 'text-zinc-500 hover:bg-zinc-200' }}">
                    <span class="flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-2 size-5">
                            <path
